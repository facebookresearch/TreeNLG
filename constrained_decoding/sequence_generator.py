...
# pytorch_translate sequence generator class with modifications that
# add stub functions for constrained decoding
# implementation of stub functions in constrained_sequence_generator.py
...
# sequence generator with stub functions for constrained decoding
